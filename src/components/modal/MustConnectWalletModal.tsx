...
import control from "../../assets/control.mp4";
import { setGlobalState, useGlobalState } from "../../services/Helper";
import { MustConnectWalletModalProps } from "../../services/Interface";

export const MustConnectWalletModal : React.FC<MustConnectWalletModalProps> = ({ actionClick }) => {
      ...
      <div className="bg-white shadow-xl shadow-black rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        ...
        <div className="flex justify-center items-center mt-5">
          <div className="rounded-full overflow-hidden w-48 h-48">
            <video src={control} autoPlay loop muted></video>
          </div>
        </div>
